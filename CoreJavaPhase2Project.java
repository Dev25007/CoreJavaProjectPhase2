...
public class CoreJavaPhase2Project {
        ...
        public static void main(String[] args) throws IOException {
            ...
            while (true) {
                ...
                if (option == 1) {
                    File file = new File("C:\\Phase2checkfiles\\files" );
                    ...
                    switch (input) {
                        case 1:
                            ...
                            File file = new File("C:\\Phase2checkfiles\\files" + name);
                        ...
                        case 2:
                            ...
                            File file1 = new File("C:\\Phase2checkfiles\\files" + name1);
                            if(file1.delete())
                        ...
                        case 3:
                            ...
                            File file2 = new File("C:\\Phase2checkfiles\\files" + fileName);
                            if( file2.exists())
                            {
